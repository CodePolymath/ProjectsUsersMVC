            ...
            (function() {
                ...
                if ("number" == typeof $obj.length) {
                    for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
                        var model = $obj[$index];
                        if (model.showing) {
                            buf.push('<li class="list-unstyled liUsers"><dl class="dl-horizontal"><dt>UserName:</dt><dd>' + jade.escape(null == (jade_interp = model.attributes.username) ? "" : jade_interp) + "</dd><dt>Email:</dt><dd>" + jade.escape(null == (jade_interp = model.attributes.email) ? "" : jade_interp) + "</dd><dt>City:</dt><dd>" + jade.escape(null == (jade_interp = model.attributes.city) ? "" : jade_interp) + "</dd><dt>State:</dt><dd>" + jade.escape(null == (jade_interp = model.attributes.state) ? "" : jade_interp) + "</dd><dt>Age:</dt><dd>" + jade.escape(null == (jade_interp = model.attributes.age) ? "" : jade_interp) + "</dd><dt>Gender:</dt><dd>" + jade.escape(null == (jade_interp = model.attributes.gender) ? "" : jade_interp) + "</dd></dl></li>");
                        }
                    }
                } else {
                    var $l = 0;
